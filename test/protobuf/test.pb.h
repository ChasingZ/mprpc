...
class LoginRequset;
struct LoginRequsetDefaultTypeInternal;
extern LoginRequsetDefaultTypeInternal _LoginRequset_default_instance_;
class LoginResponse;
...
template<> ::fixbug::LoginRequset* Arena::CreateMaybeMessage<::fixbug::LoginRequset>(Arena*);
...
class LoginRequset final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:fixbug.LoginRequset) */ {
 public:
  inline LoginRequset() : LoginRequset(nullptr) {}
  ~LoginRequset() override;
  explicit PROTOBUF_CONSTEXPR LoginRequset(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  LoginRequset(const LoginRequset& from);
  LoginRequset(LoginRequset&& from) noexcept
    : LoginRequset() {
    *this = ::std::move(from);
  }

  inline LoginRequset& operator=(const LoginRequset& from) {
    CopyFrom(from);
    return *this;
  }
  inline LoginRequset& operator=(LoginRequset&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const LoginRequset& default_instance() {
    return *internal_default_instance();
  }
  static inline const LoginRequset* internal_default_instance() {
    return reinterpret_cast<const LoginRequset*>(
               &_LoginRequset_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    1;

  friend void swap(LoginRequset& a, LoginRequset& b) {
    a.Swap(&b);
  }
  inline void Swap(LoginRequset* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(LoginRequset* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  LoginRequset* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<LoginRequset>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const LoginRequset& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const LoginRequset& from) {
    LoginRequset::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(LoginRequset* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "fixbug.LoginRequset";
  }
  protected:
  explicit LoginRequset(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:fixbug.LoginRequset)
 private:
  class _Internal;
...
// bytes name = 1;
inline void LoginRequset::clear_name() {
  _impl_.name_.ClearToEmpty();
}
inline const std::string& LoginRequset::name() const {
  // @@protoc_insertion_point(field_get:fixbug.LoginRequset.name)
  return _internal_name();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void LoginRequset::set_name(ArgT0&& arg0, ArgT... args) {
 
 _impl_.name_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:fixbug.LoginRequset.name)
}
inline std::string* LoginRequset::mutable_name() {
  std::string* _s = _internal_mutable_name();
  // @@protoc_insertion_point(field_mutable:fixbug.LoginRequset.name)
  return _s;
}
inline const std::string& LoginRequset::_internal_name() const {
  return _impl_.name_.Get();
}
inline void LoginRequset::_internal_set_name(const std::string& value) {
  
  _impl_.name_.Set(value, GetArenaForAllocation());
}
inline std::string* LoginRequset::_internal_mutable_name() {
  
  return _impl_.name_.Mutable(GetArenaForAllocation());
}
inline std::string* LoginRequset::release_name() {
  // @@protoc_insertion_point(field_release:fixbug.LoginRequset.name)
  return _impl_.name_.Release();
}
inline void LoginRequset::set_allocated_name(std::string* name) {
  if (name != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:fixbug.LoginRequset.name)
}

// bytes pwd = 2;
inline void LoginRequset::clear_pwd() {
  _impl_.pwd_.ClearToEmpty();
}
inline const std::string& LoginRequset::pwd() const {
  // @@protoc_insertion_point(field_get:fixbug.LoginRequset.pwd)
  return _internal_pwd();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void LoginRequset::set_pwd(ArgT0&& arg0, ArgT... args) {
 
 _impl_.pwd_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:fixbug.LoginRequset.pwd)
}
inline std::string* LoginRequset::mutable_pwd() {
  std::string* _s = _internal_mutable_pwd();
  // @@protoc_insertion_point(field_mutable:fixbug.LoginRequset.pwd)
  return _s;
}
inline const std::string& LoginRequset::_internal_pwd() const {
  return _impl_.pwd_.Get();
}
inline void LoginRequset::_internal_set_pwd(const std::string& value) {
  
  _impl_.pwd_.Set(value, GetArenaForAllocation());
}
inline std::string* LoginRequset::_internal_mutable_pwd() {
  
  return _impl_.pwd_.Mutable(GetArenaForAllocation());
}
inline std::string* LoginRequset::release_pwd() {
  // @@protoc_insertion_point(field_release:fixbug.LoginRequset.pwd)
  return _impl_.pwd_.Release();
}
inline void LoginRequset::set_allocated_pwd(std::string* pwd) {
  if (pwd != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:fixbug.LoginRequset.pwd)
}
