...
PROTOBUF_CONSTEXPR LoginRequset::LoginRequset(
    ::_pbi::ConstantInitialized): _impl_{
...
struct LoginRequsetDefaultTypeInternal {
  PROTOBUF_CONSTEXPR LoginRequsetDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~LoginRequsetDefaultTypeInternal() {}
  union {
    LoginRequset _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 LoginRequsetDefaultTypeInternal _LoginRequset_default_instance_;
...
const uint32_t TableStruct_test_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::fixbug::LoginRequset, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::fixbug::LoginRequset, _impl_.name_),
  PROTOBUF_FIELD_OFFSET(::fixbug::LoginRequset, _impl_.pwd_),
  ~0u,  // no _has_bits_
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 8, -1, -1, sizeof(::fixbug::LoginRequset)},
...
static const ::_pb::Message* const file_default_instances[] = {
  ...
  &::fixbug::_LoginRequset_default_instance_._instance,
...
const char descriptor_table_protodef_test_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\024.fixbug.LoginRequset\032\025.fixbug.LoginResp"
...
class LoginRequset::_Internal {
 public:
};

LoginRequset::LoginRequset(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:fixbug.LoginRequset)
}
LoginRequset::LoginRequset(const LoginRequset& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  LoginRequset* const _this = this; (void)_this;
  new (&_impl_) Impl_{
  ...
  // @@protoc_insertion_point(copy_constructor:fixbug.LoginRequset)
}

inline void LoginRequset::SharedCtor(
    ::_pb::Arena* arena, bool is_message_owned) {
  (void)arena;
  (void)is_message_owned;
  new (&_impl_) Impl_{
...
LoginRequset::~LoginRequset() {
  // @@protoc_insertion_point(destructor:fixbug.LoginRequset)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
inline void LoginRequset::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  _impl_.name_.Destroy();
  _impl_.pwd_.Destroy();
}

void LoginRequset::SetCachedSize(int size) const {
  _impl_._cached_size_.Set(size);
}

void LoginRequset::Clear() {
// @@protoc_insertion_point(message_clear_start:fixbug.LoginRequset)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* LoginRequset::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::_pbi::ReadTag(ptr, &tag);
...
uint8_t* LoginRequset::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:fixbug.LoginRequset)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:fixbug.LoginRequset)
  return target;
}

size_t LoginRequset::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:fixbug.LoginRequset)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData LoginRequset::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    LoginRequset::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*LoginRequset::GetClassData() const { return &_class_data_; }


void LoginRequset::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<LoginRequset*>(&to_msg);
  auto& from = static_cast<const LoginRequset&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:fixbug.LoginRequset)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
void LoginRequset::CopyFrom(const LoginRequset& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:fixbug.LoginRequset)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool LoginRequset::IsInitialized() const {
  return true;
}

void LoginRequset::InternalSwap(LoginRequset* other) {
  using std::swap;
  auto* lhs_arena = GetArenaForAllocation();
  auto* rhs_arena = other->GetArenaForAllocation();
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
...
::PROTOBUF_NAMESPACE_ID::Metadata LoginRequset::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_test_2eproto_getter, &descriptor_table_test_2eproto_once,
...
void UserServiceRpc::CallMethod(const ::PROTOBUF_NAMESPACE_ID::MethodDescriptor* method,
  ...
  switch(method->index()) {
    case 0:
      Login(controller,
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<const ::fixbug::LoginRequset*>(
                 request),
...
const ::PROTOBUF_NAMESPACE_ID::Message& UserServiceRpc::GetRequestPrototype(
  ...
  switch(method->index()) {
    case 0:
      return ::fixbug::LoginRequset::default_instance();
    case 1:
...
template<> PROTOBUF_NOINLINE ::fixbug::LoginRequset*
Arena::CreateMaybeMessage< ::fixbug::LoginRequset >(Arena* arena) {
  return Arena::CreateMessageInternal< ::fixbug::LoginRequset >(arena);
}
